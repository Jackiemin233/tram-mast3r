...
def main(args):
    ...
    if args.output_dir != 'results':
        import shutil
        try:
            print('Copy the source folder for fast evaluation!')
            shutil.copytree(f'results/{seq}', f'{seq_folder}')    
        except:
            print('NO original results folder!')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='results_subset', help='the output save directory')
